...
{
    // back
    texture[0] = Texture::GetInstance()->LoadTextureFromFile((strDir + strBack).toStdString(), Texture::CLAMP_TO_EDGE);
    ...
    // down
    texture[1] = Texture::GetInstance()->LoadTextureFromFile((strDir + strDown).toStdString(), Texture::CLAMP_TO_EDGE);
    ...
    // front
    texture[2] = Texture::GetInstance()->LoadTextureFromFile((strDir + strFront).toStdString(), Texture::CLAMP_TO_EDGE);
    ...
    // left
    texture[3] = Texture::GetInstance()->LoadTextureFromFile((strDir + strLeft).toStdString(), Texture::CLAMP_TO_EDGE);
    ...
    // right
    texture[4] = Texture::GetInstance()->LoadTextureFromFile((strDir + strRight).toStdString(), Texture::CLAMP_TO_EDGE);
    ...
    // up
    texture[5] = Texture::GetInstance()->LoadTextureFromFile((strDir + strUp).toStdString(), Texture::CLAMP_TO_EDGE);
